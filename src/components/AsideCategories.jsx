      ...
      <div className="asideCategories__body">
        <ul className="asideCategories__body-list">
          <li className="asideCategories__body-list__item ">
            <NavLink to="/home" activeClassName="active" className="asideCategories__body-list__item-link asideCategories__body-list__item-link--active">
              <FaHome size={18}/>
            Home</NavLink>
          </li>
          <li className="asideCategories__body-list__item">
            <NavLink to="/add" activeClassName="active" className="asideCategories__body-list__item-link">
              <FaBasketballBall size={16}/>
            Sports</NavLink>
          </li>
          <li className="asideCategories__body-list__item">
            <NavLink to="/leaderboard" activeClassName="active" className="asideCategories__body-list__item-link">
              <FaMusic size={16}/>
            Music</NavLink>
          </li>
          <li className="asideCategories__body-list__item">
