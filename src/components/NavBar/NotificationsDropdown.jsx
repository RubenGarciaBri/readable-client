...
const NotificationsDropdown = () => {
  ...
  return (
    <div style={{
      ...
      <button className="navbar__right-notifications" onClick={() => setIsOpen(!isOpen)}>
        <IoNotificationsSharp className="navbar__right-notifications__icon"/>
      </button>
      {isOpen && ( 
          <div ref={node} className="navbar__right-notifications__dropdown shadow-slim">
          <div className="navbar__right-notifications__dropdown-top">
            <span className="navbar__right-notifications__dropdown-top__span">Notifications</span>
          </div>
