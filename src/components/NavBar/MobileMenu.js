...
const MobileMenu = ({ dispatch, authenticated, user }) => {
  ...
  const loggedInMenu = () => (
    ...
    >
      <button className="navbarMobile__right-mobileMenu" onClick={handleOpen}>
      ...
      {isOpen && (
        ...
        >
          <ul className="navbarMobile__right-mobileMenu__dropdown-list">
            <li className="navbarMobile__right-mobileMenu__dropdown-list__profile">
              <Link
                to={`/profile/${user.credentials.userName}`}
                className={
                  'navbarMobile__right-mobileMenu__dropdown-list__profile-link'
                }
              >
                <img
            ...
            <li className="navbarMobile__right-mobileMenu__dropdown-list__signout">
              <button
  ...
  const loggedOutMenu = () => (
    ...
    >
      ...
      {isOpen && (
        ...
        >
          <ul className="navbarMobile__right-mobileMenu__dropdown-list">
            <li className="navbarMobile__right-mobileMenu__dropdown-list__login">
              <Link
                to="/login"
            ...
            <li className="navbarMobile__right-mobileMenu__dropdown-list__signup">
              <Link
                to="/signup"
  ...
  return authenticated === true ? loggedInMenu() : loggedOutMenu();
};
