    ...
    <div className={`notification-container ${position}`}>
      {notifications.length > 0 ? 
        notifications.map((notification, i) => {
          return (
            <div style={{backgroundColor: generateBgColor(notification.type)}} key={notification.id} className={`notification toast ${isVisible === true ? 'notification-visible' : 'notification--hidden'}`}>
