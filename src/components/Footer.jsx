    ...
    <div className="footer-section">
      <div className="footer">
        <div className="footer__left">
          ...
          <p className="footer__left-tex">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Dicta ratione incidunt nesciunt soluta adipisci quia optio delectus.</p>
        </div>
