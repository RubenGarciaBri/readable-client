...
export let posts = {
  '01': {
    ...
    body: 'Shoutout to all the speakers I know for whom English is not a first language, but can STILL explain a concept well. It\'s hard enough to give a good talk in your mother tongue!',
    category: 'sports',
    author: 'sarah_edo',
  ...
  '02': {
    ...
    body: 'The idea of best practices being a negative thing is an interesting concept.',
    category: 'business',
    author: 'eliot_13',
    timestamp: 1515044095650,
    voteScore: 7,
    favourites: ['tylermcginnis'],
    comments: ['fap8sdxppna8oabnxljzcv', '3km0v4hf1ps92ajf4z2ytg', '3km0v4hf1ps92a1f4zyyt3'],
    upvotes: [],
    downvotes: []
  },
  '03': {
    ...
    body: 'This group has been producing amazing songs lately, such a shame I couldn\'t see them in London last year. The quality just gets better and better, crazy...',
    category: 'music',
    author: 'deathmetal_87',
    timestamp: 1514044994650,
    voteScore: 21,
    favourites: ['tylermcginnis'],
    comments: ['fap8sdxppna8oabnxljzcv', '3km0v4hf1ps92ajf4z2ytg', '3km0v4hf1ps92a1f4zyyt3', 'a2p8sdxppna8oabnxljzcv', 'klp8sdxppna8oabnxljzcv', 'faa8s1xjpna83adnxljzcv'],
    upvotes: [],
    downvotes: []
  }
}
